...
export default function Home() {
  return (
    <div className="bg-[url(/cactiBackgroundPattern.svg)] bg-repeat">
      <div className="bg-black/30"> 
        <header>
          <TopBar />
        </header>
        <main
          className={`flex min-h-screen flex-col items-center ${inter.className} bg-black/30`}
        >
          {/* Top Panel */}
          <div className=" h-[80vh] flex flex-col items-center justify-center container mx-auto bg-fade-black-to-transparent">
            <div className="flex flex-col my-5">
              ...
              <div className="text-[28px] my-5">
                Interact with Web3 Protocols through Natural Language powered by
                OpenAI
              </div>
          ...
          <div
            className="grid grid-cols-2 mx-auto h-full"
            style={{ height: "80vh" }}
          >
            <div>
              <FeatureCardImg
          ...
          <div className="flex flex-col items-center justify-center mx-auto w-full bg-fade-black-to-transparent h-[40vh] text-primary ">
            ...
            <div className="text-center flex flex-col">
              ...
              <p className="text-sm text-[28px] text-white/80">
                Use our developer features and start building in the open with
                us.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
              ...
              <div className="p-4">
                <FeatureCardText
                  ...
                  subHeader="Trade assets, manage NFTs, and more through simple text requests."
                />
              </div>
              <div className="p-4">
                <FeatureCardText
                  header="Easy Integrations"
                  subHeader="Work with Javascript on the frontend or Python on the backend."
                />
              </div>
              <div className="p-4">
                <FeatureCardText
                  header="ReactJS Component Framework"
                  subHeader="Integrate UI with minimal frontend knowledge."
                />
              </div>
              ...
              <div className="p-4">
                <FeatureCardText
                  ...
                  subHeader="Ensure secure identification with web3 wallets."
                />
              </div>
              <div className="p-4">
                <FeatureCardText
                  header="Simplified Transaction Handling"
                  subHeader="Let Cacti handle web3 transactions for user-friendly experiences."
                />
              </div>
              <div className="p-4">
                <FeatureCardText
                  header="Widget Commands"
                  subHeader="Create interaction dialogue boxes for web3 actions or data access."
                />
              </div>
              ...
              <div className="p-4">
                <FeatureCardText
                  ...
                  subHeader="Build context from previous interactions for improved user experiences."
                />
              </div>
              <div className="p-4">
                <FeatureCardText
                  header="Configurable Chat Modules"
                  subHeader="Customize chat modules with alternative LLMs or prompts."
                />
              </div>
              ...
              <div className="p-4">
                <FeatureCardText
                  ...
                  subHeader="Benefit from real-time updates and smooth handling of widget commands."
                />
              </div>
              <div className="p-4">
                <FeatureCardText
                  header="Rich Media Support"
                  subHeader="Handle structured media output like tables, NFTs, etc."
                />
              </div>
              <div className="p-4">
                <FeatureCardText
                  header="More to come..."
                  subHeader="Join our Community on Discord."
                />
              </div>
            </div>
          </div>
