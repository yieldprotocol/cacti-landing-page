    ...
    <div className="text-xl p-8 gap-4">
      ...
      <div>
        ...
        <p className="text-base">
          ...
          websites operated by us at{" "}
          https://cacti.finance and
          https://yieldprotocol.com and any other website operated by us on
          which these Terms of Service are posted (collectively, the “Site”) and
          through our related technologies (collectively, the Interface and
          Site, including all existing and any updated or new features,
          functionality and technology, the “Service”). All access and use of
          the Service is subject to the terms and conditions contained in these
          ...
          entity or organization and representing to us that you have the
          authority to bind that entity or organization to these Terms of
        ...
        <p className="text-base">
          <strong>
            <em>
              ...
              (1) YOU WILL ONLY BE PERMITTED TO PURSUE CLAIMS AGAINST US ON AN
        ...
        <p className="text-base">
          ...
          metadata. We do not collect any personally identifiable information
          (”Personal Data”) from you (e.g., Ethereum address or transaction
          amounts) when you use the Interface or Protocol. When you use our
          Site, however, we may receive your Personal Data. For more information
          regarding our collection, use and disclosure of personal data and
          certain other data, please see our Privacy Policy, located at
        ...
        <p className="text-base">
          ...
          proprietary rights and laws. Except as expressly authorized by us
          ...
          that the foregoing does not apply to your own content that you upload
        ...
        <p className="text-base">
          ...
          to us. Nothing in these Terms of Service or the Service should be
          construed as granting, by implication, estoppel, or otherwise, any
          license or right to use any of our Trademarks displayed on the
        ...
        <p className="text-base">
          ...
          content that is available via the Site. Without limiting the
          foregoing, we and our designees will have the right to remove from the
          Site any content that violates these Terms of Service or is deemed by
          us, in its sole discretion, to be otherwise objectionable. You agree
        ...
        <p className="text-base">
          ...
          the rights, property, or personal safety of us, its users, or the
        ...
        <p className="text-base">
          ...
          third party. We have no control over and is not responsible for such
          ...
          through Third-Party Services, or on the privacy practices of
          ...
          such services. You, and not us, will be responsible for any and all
          costs and charges associated with your use of any Third-Party
        ...
        <p className="text-base">
          ...
          Service, any content, your connection to the Service, your violation
          of these Terms of Service, or your violation of any rights of another.
          We will provide notice to you of any such claim, suit, or proceeding.
          We reserve the right to assume the exclusive defense and control of
          any matter which is subject to indemnification under this section, and
        ...
        <p className="text-base">
          ...
          THE SERVICE WILL BE ACCURATE OR RELIABLE; OR (D) THE QUALITY OF ANY
        ...
        <p className="text-base">
          ...
          AS THOSE FOLLOWING THE ETHEREUM TOKEN STANDARD (ERC-20) AND BRIDGING
          ACROSS DIFFERENT BLOCKCHAIN SOLUTIONS. YOU FURTHER UNDERSTAND THAT THE
          MARKETS FOR THESE DIGITAL ASSETS ARE HIGHLY VOLATILE DUE TO VARIOUS
          FACTORS, INCLUDING ADOPTION, SPECULATION, TECHNOLOGY, SECURITY, AND
        ...
        <p className="text-base">
          ...
          GOODWILL, USE, OR DATA OR OTHER INTANGIBLE LOSSES (EVEN IF THE YIELD
          ...
          RESULTING FROM: (A) THE USE OR THE INABILITY TO USE THE SERVICE; (B)
          ...
          THE SERVICE; (E)&nbsp;INTERRUPTION OR CESSATION OF FUNCTION RELATED TO
          THE INTERFACE; (F) BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE THAT MAY
          BE TRANSMITTED TO OR THROUGH THE INTERFACE; (G) ERRORS OR OMISSIONS
          IN, OR LOSS OR DAMAGE INCURRED AS A RESULT OF THE USE OF, ANY CONTENT
          MADE AVAILABLE THROUGH THE INTERFACE; OR (H) ANY OTHER MATTER RELATING
          TO THE SERVICE. IN NO EVENT WILL THE YIELD PARTIES’ TOTAL LIABILITY TO
        ...
        <p className="text-base">
          ...
          between you and Yield, whether arising out of or relating to these
          ...
          entering into these Terms of Service, you and Yield are each waiving
          the right to a trial by jury or to participate in a className action.
        ...
        <p className="text-base">
          <strong>
            <em>
              ...
              PROCEEDING. UNLESS BOTH YOU AND WE AGREE OTHERWISE, THE ARBITRATOR
        ...
        <p className="text-base">
          ...
          contact@yield.is. If such efforts prove unsuccessful, a party who
          intends to seek arbitration must first send to the other a written
          Notice of Dispute (“Notice”). The Notice to us should be sent to
          contact@yield.is (“Notice Address”). The Notice must (i) describe the
          nature and basis of the claim or dispute and (ii) set forth the
          specific relief sought. If us and you do not resolve the claim within
          sixty (60) calendar days after the Notice is received, you or us may
        ...
        <p className="text-base">
          ...
          value of the relief sought is $75,000 or less, at your request, we
          will pay all Arbitration Fees. If the value of relief sought is more
          than $75,000 and you are able to demonstrate to the arbitrator that
          you are economically unable to pay your portion of the Arbitration
          Fees or if the arbitrator otherwise determines for any reason that you
          should not be required to pay your portion of the Arbitration Fees, we
          ...
          compared to the costs of litigation, we will pay as much of the
        ...
        <p className="text-base">
          ...
          sending us written notice within thirty (30) calendar days of the
        ...
        <p className="text-base">
          ...
          agreements between you and us with respect to the Service. You also
          ...
          set forth above, you and us submit to the personal and exclusive
          jurisdiction of the state and federal courts located within the
          Northern District of California.The failure of us to exercise or
          ...
          prior written consent of us, but we may assign or transfer these Terms
          of Service, in whole or in part, without restriction. The section
          titles in these Terms of Service are for convenience only and have no
          legal or contractual effect. As used in these Terms of Service, the
          ...
          followed by the words “without limitation.” Notices to you may be made
          ...
          displaying notices or links to notices generally on the Service. We
